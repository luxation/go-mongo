...
type Client interface {
	...
	FindAll(d Document, filters bson.M, findOptions ...*FindOptions) ([]byte, error)
...
func (m *mongoClient) FindAll(d Document, filters bson.M, findOptions ...*FindOptions) ([]byte, error) {
	ctx, cancel := m.getContext()
